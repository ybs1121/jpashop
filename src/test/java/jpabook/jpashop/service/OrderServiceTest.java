...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        assertEquals("주문한 상품 종류가 정확해야한다.",1,getOrder.getOrderItems().size());
        assertEquals("주문 가격은 가격* 주문이다.",10000*orderCount,getOrder.getTotalPrice());
    ...
    @Test(expected = NotEnounghStockException.class)
